...
# Create dummy files and materials
...
for data in banks_data:
    ...
    banks.append(bank)
    print(f"Created question bank: {bank.title}")
...
print(f"Created {CourseCategory.objects.count()} categories")
print(f"Created {Course.objects.count()} courses")
print(f"Created {StudyMaterial.objects.count()} study materials")
print(f"Created {QuestionBank.objects.count()} question banks")
